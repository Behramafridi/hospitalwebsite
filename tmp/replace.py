...
pattern = r'<div class=\"row mb-5\">\s*<!-- Left: Doctor Info -->\s*<div class=\"col-md-6 pe-md-4\">\s*<h6 class=\"fw-bold mb-3\" style=\"color: #343a40;\">Doctor Info</h6>\s*<div style=\"color: #6c757d; font-size: 0\.95rem; line-height: 1\.6;\">\s*<p class=\"mb-1 text-dark fw-bold\">\{\{ \$registration->doctor->name \?\? \'Dr Sohail Wahid\' \}\}</p>\s*<p class=\"mb-1\">CallDoc Ltd</p>\s*<p class=\"mb-1\">\s*\{\{ \$registration->doctor->addressRegister->address \?\? \'18 BEHAN HOUSE, ARDEN ROAD, TULLAMORE, OFFALY R35 T6C3, IRELAND\' \}\}\s*</p>\s*<p class=\"mb-0\">\{\{ \$registration->doctor->phoneRegister->phone \?\? \'\+353871085185\' \}\}</p>\s*</div>\s*</div>\s*<!-- Right: Patient Info -->\s*<div class=\"col-md-6 ps-md-4\">\s*<h6 class=\"fw-bold mb-3\" style=\"color: #343a40;\">Patient Info</h6>\s*<div style=\"color: #6c757d; font-size: 0\.95rem;\">\s*<div class=\"d-flex mb-2\">\s*<span class=\"fw-bold text-dark\" style=\"width: 80px;\">Name:</span>\s*<span>\{\{ \$registration->patient_first_name \}\}\s*\{\{ \$registration->patient_last_name \}\}</span>\s*</div>\s*<div class=\"d-flex mb-2\">\s*<span class=\"fw-bold text-dark\" style=\"width: 80px;\">Address:</span>\s*<span>\{\{ \$registration->address \?: \'N/A\' \}\}</span>\s*</div>\s*<div class=\"d-flex mb-2\">\s*<span class=\"fw-bold text-dark\" style=\"width: 80px;\">Contact:</span>\s*<span>\{\{ \$registration->mobile \?: \'N/A\' \}\}</span>\s*</div>\s*<div class=\"d-flex mb-3\">\s*<span class=\"fw-bold text-dark\" style=\"width: 80px;\">DOB:</span>\s*<span>\{\{ \$registration->bod_of_birth \? \\\Carbon\\\Carbon::parse\(\$registration->bod_of_birth\)->format\(\'M d, y\'\) : \'N/A\' \}\}</span>\s*</div>\s*<div class=\"mt-4 pt-2\">\s*<span class=\"fw-bold text-dark\">Appointment ID:</span>\s*<span>\{\{ \$registration->id \}\}</span>\s*</div>\s*</div>\s*</div>\s*</div>'
...
print(f'Made {num_subs} replacements')
