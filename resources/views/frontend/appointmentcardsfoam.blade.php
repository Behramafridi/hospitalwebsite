...
<style>
    /* Section Visibility without JS */
    .step3-form-wrap { display: none; }
    #cards-section { display: block; }
    
    /* When a form is targeted, hide the cards and show the form */
    #form1:target, #form2:target, #form3:target, #form4:target, 
    #form5:target, #form6:target, #form7:target, #form8:target,
    #form9:target, #form10:target, #form11:target, #form12:target,
    #form13:target, #form14:target, #form15:target, #form16:target,
    #form17:target, #form18:target, #form19:target, #form20:target {
        display: block;
    }
    
    #form1:target ~ #cards-section, #form2:target ~ #cards-section, #form3:target ~ #cards-section, #form4:target ~ #cards-section,
    #form5:target ~ #cards-section, #form6:target ~ #cards-section, #form7:target ~ #cards-section, #form8:target ~ #cards-section,
    #form9:target ~ #cards-section, #form10:target ~ #cards-section, #form11:target ~ #cards-section, #form12:target ~ #cards-section,
    #form13:target ~ #cards-section, #form14:target ~ #cards-section, #form15:target ~ #cards-section, #form16:target ~ #cards-section,
    #form17:target ~ #cards-section, #form18:target ~ #cards-section, #form19:target ~ #cards-section, #form20:target ~ #cards-section {
        display: none !important;
    }

    #form1:target ~ #cards-nav, #form2:target ~ #cards-nav, #form3:target ~ #cards-nav, #form4:target ~ #cards-nav,
    #form5:target ~ #cards-nav, #form6:target ~ #cards-nav, #form7:target ~ #cards-nav, #form8:target ~ #cards-nav,
    #form9:target ~ #cards-nav, #form10:target ~ #cards-nav, #form11:target ~ #cards-nav, #form12:target ~ #cards-nav,
    #form13:target ~ #cards-nav, #form14:target ~ #cards-nav, #form15:target ~ #cards-nav, #form16:target ~ #cards-nav,
    #form17:target ~ #cards-nav, #form18:target ~ #cards-nav, #form19:target ~ #cards-nav, #form20:target ~ #cards-nav {
        display: none !important;
    }

    .service-card { transition: transform 0.3s ease; text-decoration: none; }
    .service-card:hover { transform: translateY(-5px); filter: brightness(1.1); }
    
    /* Conditional Details Visibility */
    .conditional-details { display: none; }
</style>

<!-- start code Doctor Selection -->
<div id="content-step-3" class="wizard-step-content">
    
    <!-- Target Hooks for CSS - No JS Needed -->
    <div id="form1" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #6366f1, #a855f7);">
                <i class="fa-solid fa-lungs me-2"></i> Asthma Health &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-asthma" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Asthma Health">
                    <div class="row g-3">
                        <div class="col-md-6"><label class="form-label" for="full_name">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label" for="date_of_birth">Date of Birth</label><input type="date" class="form-control" id="date_of_birth" name="date_of_birth" required></div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6"><label class="form-label" for="email">Email</label><input type="email" class="form-control" name="email" required></div>
                        <div class="col-md-6"><label class="form-label" for="phone">Phone</label><input type="tel" class="form-control" name="phone" required></div>
                        <div class="col-md-6"><label class="form-label" for="height">Height</label><input type="text" class="form-control" name="height" required></div>
                        <div class="col-md-6"><label class="form-label" for="weight">Weight</label><input type="text" class="form-control" name="weight" required></div>
                        <div class="col-md-6">
                            <label class="form-label" for="diagnosed_asthma">Diagnosed asthma?</label>
                            <select class="form-select toggle-details" name="diagnosed_asthma" data-target="asthma_diag_details" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                        <div id="asthma_diag_details" class="col-md-12 conditional-details">
                            <label class="form-label" for="asthma_diag_details">Please provide details about your diagnosis</label>
                            <textarea class="form-control" name="asthma_diag_details" rows="2"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="current_inhales">Current inhaler?</label>
                            <select class="form-select toggle-details" name="current_inhales" data-target="asthma_inhaler_details" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                        <div id="asthma_inhaler_details" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about your inhaler</label>
                            <textarea class="form-control" name="asthma_inhaler_details" rows="2"></textarea>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Night symptoms?</label>
                            <select class="form-select toggle-details" name="night_symptoms" data-target="asthma_night_details" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                        <div id="asthma_night_details" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about your night symptoms</label>
                            <textarea class="form-control" name="asthma_night_details" rows="2"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="Hospital_admissions">Hospital admissions?</label>
                            <select class="form-select toggle-details" name="Hospital_admissions" id="Hospital_admissions" data-target="asthma_hosp_details" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                        <div id="Hospital_admissions_details" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about your hospital admissions</label>
                            <textarea class="form-control" name="Hospital_admissions_details" rows="2"></textarea>
                        </div>
                        <div class="col-md-6"><label class="form-label">Symptoms frequency?</label><input type="text" class="form-control" name="symptoms_frequency" placeholder="e.g. Daily, Weekly" required></div>
                        <div class="col-md-6"><label class="form-label">Triggers?</label><input type="text" class="form-control" name="triggers" required></div>
                    </div>
                    
                        

                        <!-- Prescription Delivery Feature -->
                        <div class="mb-3 prescription-delivery-wrapper">
                            <label class="form-label">Select Prescription Delivery (in case medication is required)</label>
                            <select class="form-select prescription-delivery-select" id="prescriptionDelivery" name="prescriptionDelivery">
                        ...
                        <div class="pharmacy-options-container d-none">
                            <div class="mb-3">
                                <label class="form-label" for="pharmacyCountry">Select Country</label>
                                <select class="form-select pharmacy-country-select" id="devlivaryCountry" name="devlivaryCountry">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select pharmacy-name-select" id="devlivaryName" name="devlivaryName">
                                    <option selected disabled>Choose Pharmacy</option>
                                </select>
                                <input type="hidden" name="pharmacyPhone" class="pharmacy-phone-hidden">
                            </div>

                            <!-- Styled Pharmacy Info Box -->
                            <div class="pharmacy-info-box p-4 rounded text-white shadow-sm mb-3 d-none" style="background-color:#0dcaf0;">
                                <p class="mb-2" style="font-size: 1.1rem;">Name: <span class="pharmacy-info-name"></span></p>
                                <p class="mb-2" style="font-size: 1.1rem; color: #fff !important;">County: <span class="pharmacy-info-county"></span></p>
                                <p class="mb-0" style="font-size: 1.1rem; color: #fff !important;">Phone: <span class="pharmacy-info-phone"></span></p>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between mt-4">
                            <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-asthma')" class="btn btn-primary px-4" style="background: linear-gradient(135deg, #6366f1, #a855f7); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <div id="form2" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #f43f5e, #be123c);">
                <i class="fa-solid fa-house-medical me-2"></i> Migraine &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                                <form id="form-primary" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                    <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label" for="date_of_birth">Date of Birth</label><input type="date" class="form-control" name="date_of_birth" id="date_of_birth" required></div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6"><label class="form-label">Height</label><input type="text" class="form-control" name="height" required></div>
                        <div class="col-md-6"><label class="form-label">Weight</label><input type="text" class="form-control" name="weight" required></div>
                     
                     
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_0" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                        <div id="details_any_allergies_0" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about your allergies</label>
                            <textarea class="form-control" name="details_any_allergies_0_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_1" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                        <div id="details_any_medication_1_text" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about your medication</label>
                            <textarea class="form-control" name="details_any_medication_1_text" rows="2"></textarea>
                        </div>


                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                         <div class="col-md-6"><label class="form-label" for="by_doctor">Diagnosed by doctor?</label><input type="text" class="form-control" name="by_doctor" id="by_doctor" required></div>
                          <div class="col-md-6"><label class="form-label" for="current_dose">Current dose?</label><input type="text" class="form-control" name="current_dose" id="current_dose" required></div>
                           <div class="col-md-6"><label class="form-label" for="test_date">Last blood test date?</label><input type="text" class="form-control" name="test_date" id="test_date" required></div>
                           <div class="col-md-6"><label class="form-label" for="symptoms_worsening">Symptoms worsening?</label><input type="text" class="form-control" name="symptoms_worsening" id="symptoms_worsening" required></div>
                           <div class="col-md-6"><label class="form-label" for="planning_pregnancy">Pregnant or planning pregnancy?</label><input type="text" class="form-control" name="planning_pregnancy" id="planning_pregnancy" required></div>
                        
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_113" type="radio" name="services_before" id="services_yes"  required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_113" type="radio" name="services_before" id="services_no"  required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        ...
                        <div class="mb-3 prescription-delivery-wrapper">
                            <label class="form-label">Select Prescription Delivery (in case medication is required)</label>
                            <select class="form-select prescription-delivery-select" name="prescriptionDelivery">
                                <option selected disabled>Choose Option</option>
                                <option value="Collect at Pharmacy">Collect at Pharmacy</option>
                                <option value="Clinic Pickup">Clinic Pickup</option>
                            </select>
                        ...
                        <div class="pharmacy-options-container d-none">
                            <div class="mb-3">
                                <label class="form-label" for="pharmacyCountry">Select Country</label>
                                <select class="form-select pharmacy-country-select" name="devlivaryCountry">
                                    <option selected disabled>Choose Business State</option>
                                    <option value="Carlow">Carlow</option>
                                    <option value="Cavan">Cavan</option>
                                    <option value="Clare">Clare</option>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Select Pharmacy</label>
                                <select class="form-select pharmacy-name-select" name="devlivaryName">
                                    <option selected disabled>Choose Pharmacy</option>
                                </select>
                                <input type="hidden" name="devlivaryName" class="pharmacy-phone-hidden">
                            </div>
...
<div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-primary')" class="btn btn-danger px-4" style="background: linear-gradient(135deg, #f43f5e, #be123c); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form3" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #10b981, #059669);">
                <i class="fa-solid fa-heart-pulse me-2"></i> Order Counselling Therapy Coming Soon &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-cardio" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                     <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_2" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                        <div id="details_any_allergies_0_text" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about your allergies</label>
                            <textarea class="form-control" name="details_any_allergies_0_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_3" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div id="details_any_medication_1_text" class="col-md-12 conditional-details">
                         ...
                         <div class="col-md-6"><label class="form-label" for="services_before">Have you used online doctor services before?</label><input type="text" class="form-control" name="services_before" id="services_before" required></div>
                          <div class="col-md-6"><label class="form-label" for="both_sides">One or both sides?</label><input type="text" class="form-control" name="both_sides" id="both_sides" required></div>
                          <div class="col-md-6"><label class="form-label" for="aura_present">Aura present?</label><input type="text" class="form-control" name="aura_present" id="aura_present" required></div>
                           <div class="col-md-6"><label class="form-label" for="Nausea_vomiting">Nausea/vomiting?</label><input type="text" class="form-control" name="Nausea_vomiting" id="Nausea_vomiting" required></div>
                            <div class="col-md-6"><label class="form-label" for="triggers">Triggers?</label><input type="text" class="form-control" name="triggers" id="triggers" required></div>
                            <div class="col-md-6"><label class="form-label" for="Current_medication">Current medication?</label><input type="text" class="form-control" name="Current_medication" id="Current_medication" required></div>
                            
                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_112" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_112" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_112" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_112_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
                                    <i class="fa-solid fa-calendar-check me-2"></i> Select Appointment Date
                                </label>
                                <input type="date" class="form-control border-primary" name="appointmentDate" required min="{{ date('Y-m-d') }}">
                                <small class="text-muted">Please select your preferred date for the session.</small>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="pharmacy-options-container d-none">
                            <div class="mb-3">
                                <label class="form-label" for="pharmacyCountry">Select Country</label>
                                <select class="form-select pharmacy-country-select" name="pharmacyCountry">
                                    <option selected disabled>Choose Business State</option>
                                    <option value="Carlow">Carlow</option>
                                    <option value="Cavan">Cavan</option>
                                    <option value="Clare">Clare</option>
                            ...
                            <div class="mb-3">
                                <label class="form-label">Select Pharmacy</label>
                                <select class="form-select pharmacy-name-select" name="pharmacyName">
                                    <option selected disabled>Choose Pharmacy</option>
                                </select>
                                <input type="hidden" name="pharmacyPhone" class="pharmacy-phone-hidden">
                            </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                             <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-cardio')" class="btn btn-success px-4" style="background: linear-gradient(135deg, #10b981, #059669); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <div id="form4" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #0ea5e9, #2563eb);">
                <i class="fa-solid fa-brain me-2"></i> Hay Fever / Allergies &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-neuro" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                    <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_4" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_5" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div id="details_any_medication_1_text" class="col-md-12 conditional-details">
                         ...
                         <div class="col-md-6"><label class="form-label" for="year_round">Seasonal or year-round?</label><input type="text" class="form-control" name="year_round" id="year_round" required></div>
               
                          <div class="col-md-6"><label class="form-label" for="main_symptoms">Main symptoms?</label><input type="text" class="form-control" name="main_symptoms" id="main_symptoms" required></div>
                          
                            <div class="col-md-6"><label class="form-label" for="asthma_history">Asthma history?</label><input type="text" class="form-control" name="asthma_history" id="asthma_history" required></div>
                               <div class="col-md-6"><label class="form-label" for="medications_tried">Medications tried?</label><input type="text" class="form-control" name="medications_tried" id="medications_tried" required></div>

                                <div class="col-md-6"><label class="form-label" for="eye_symptoms">Eye symptoms?</label><input type="text" class="form-control" name="eye_symptoms" id="eye_symptoms" required></div>

                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_111" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_111" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                             <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-neuro')" class="btn btn-info text-white px-4" style="background: linear-gradient(135deg, #0ea5e9, #2563eb); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <div id="form5" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #f59e0b, #ea580c);">
                <i class="fa-solid fa-venus me-2"></i> Contraception Health &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-women" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                  <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_6" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_7" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                       ...
                       <div class="col-md-6"><label class="form-label" for="contraception">What type of contraception are you currently using?</label><input type="text" class="form-control" name="contraception" id="contraception" required></div>
                       <div class="col-md-6"><label class="form-label" for="menstrual_period">When was your last menstrual period?</label><input type="text" class="form-control" name="menstrual_period" id="menstrual_period" required></div>
                       
                         
                           <div class="col-md-6">
                            <label class="form-label" for="you_smoke">Do you smoke? </label>
                            <select class="form-select" name="you_smoke" id="you_smoke" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="had_blood">Have you ever had blood clots?</label><input type="text" class="form-control" name="had_blood" id="had_blood" required></div>
                           <div class="col-md-6"><label class="form-label" for="with_aura">History of migraines with aura?</label><input type="text" class="form-control" name="with_aura" id="with_aura" required></div>

                            <div class="col-md-6"><label class="form-label" for="blood_pressure">High blood pressure?</label><input type="text" class="form-control" name="blood_pressure" id="blood_pressure" required></div>
                            <div class="col-md-6"><label class="form-label" for="breastfeeding">Are you pregnant or breastfeeding?</label><input type="text" class="form-control" name="breastfeeding" id="breastfeeding" required></div>
                            <div class="col-md-6"><label class="form-label" for="effects_before">Any hormone-related side effects before?</label><input type="text" class="form-control" name="effects_before" id="effects_before" required></div>
                            <div class="col-md-6"><label class="form-label" for="contraception_before">Have you used this contraception before successfully?</label><input type="text" class="form-control" name="contraception_before" id="contraception_before" required></div>

                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_110" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_110" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                             <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-women')" class="btn btn-warning px-4" style="background: linear-gradient(135deg, #f59e0b, #ea580c); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <div id="form6" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #d946ef, #a21caf);">
                <i class="fa-solid fa-hand-dots me-2"></i> Period Delay Treatment &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-skin" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                  <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_8" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_9" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div id="details_any_medication_1_text" class="col-md-12 conditional-details">
                         ...
                         <div class="col-md-6"><label class="form-label" for="services_before">Have you used online doctor services before?</label><input type="text" class="form-control" name="services_before" id="services_before" required></div>
                          ...
                          <div class="col-md-6"><label class="form-label" for="last_period">What is the first day of your last period?</label><input type="text" class="form-control" name="last_period" id="last_period" required></div>
               
                         <div class="col-md-6"><label class="form-label" for="your_period">How many days do you want to delay your period?</label><input type="text" class="form-control" name="your_period" id="your_period" required></div>
                          

                         <div class="col-md-6"><label class="form-label" for="delaying">Reason for delaying?</label><input type="text" class="form-control" name="delaying" id="delaying" required></div>

                         <div class="col-md-6"><label class="form-label" for="medication_before">Have you used period delay medication before?</label><input type="text" class="form-control" name="medication_before" id="medication_before" required></div>

                         <div class="col-md-6"><label class="form-label" for="blood_clots">Any history of blood clots?</label><input type="text" class="form-control" name="blood_clots" id="blood_clots" required></div>

                         <div class="col-md-6"><label class="form-label" for="pregnant">Are you currently pregnant?</label><input type="text" class="form-control" name="pregnant" id="pregnant" required></div>
                           
                         <div class="col-md-6"><label class="form-label" for="disorders">Any hormonal disorders?</label><input type="text" class="form-control" name="disorders" id="disorders" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_109" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_109" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_109" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_109_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-skin')" class="btn btn-primary px-4" style="background: linear-gradient(135deg, #d946ef, #a21caf); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <div id="form7" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #14b8a6, #0f766e);">
                <i class="fa-solid fa-head-side-virus me-2"></i> Genital Thrush  &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-mental" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                 <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_10" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_11" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="experiencing">What symptoms are you experiencing</label><input type="text" class="form-control" name="experiencing" id="experiencing" required></div>
                         <div class="col-md-6"><label class="form-label" for="discharge">Color/consistency of discharge?</label><input type="text" class="form-control" name="discharge" id="discharge" required></div>
               
                      
                          
                          <div class="col-md-6"><label class="form-label" for="been_present">How long have symptoms been present?</label><input type="text" class="form-control" name="been_present" id="been_present" required></div>

                          <div class="col-md-6"><label class="form-label" for="episode">Is this your first episode?</label><input type="text" class="form-control" name="episode" id="episode" required></div>

                           <div class="col-md-6"><label class="form-label" for="urination">Any pain during urination or sex?</label><input type="text" class="form-control" name="urination" id="urination" required></div>
                            
                              <div class="col-md-6"><label class="form-label" for="recently">Used antibiotics recently?</label><input type="text" class="form-control" name="recently" id="recently" required></div>

                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_108" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_108" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_108" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_108_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-mental')" class="btn btn-teal text-white px-4" style="background: linear-gradient(135deg, #14b8a6, #0f766e); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <div id="form8" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #64748b, #334155);">
                <i class="fa-solid fa-bone me-2"></i> Bacterial Vaginosis &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-ortho" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                  <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_12" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_13" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div id="details_any_medication_1_text" class="col-md-12 conditional-details">
                         ...
                         <div class="col-md-6"><label class="form-label" for="services_before">Have you used online doctor services before?</label><input type="text" class="form-control" name="services_before" id="services_before" required></div>
                          ...
                          <div class="col-md-6"><label class="form-label" for="vaginal_discharge">Vaginal discharge odor?</label><input type="text" class="form-control" name="vaginal_discharge" id="vaginal_discharge" required></div>

                          <div class="col-md-6"><label class="form-label" for="color">Discharge color?</label><input type="text" class="form-control" name="color" id="color" required></div>
                         <div class="col-md-6"><label class="form-label" for="of_symptoms">Duration of symptoms??</label><input type="text" class="form-control" name="of_symptoms" id="of_symptoms" required></div>
                          <div class="col-md-6"><label class="form-label" for="Previous_by">Previous BV episodes?</label><input type="text" class="form-control" name="Previous_by" id="Previous_by" required></div>
                          <div class="col-md-6"><label class="form-label" for="pelvic_pain">Any pelvic pain?</label><input type="text" class="form-control" name="pelvic_pain" id="pelvic_pain" required></div> 
                          
                          <div class="col-md-6"><label class="form-label" for="you_pregnant">Are you pregnant?</label><input type="text" class="form-control" name="you_pregnant" id="you_pregnant" required></div> 


                          <div class="col-md-6"><label class="form-label" for="IUD">Using an IUD?</label><input type="text" class="form-control" name="IUD" id="IUD" required></div> 
                        ...
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_107" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_107" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_107" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_107_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
...
<div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-ortho')" class="btn btn-secondary px-4" style="background: linear-gradient(135deg, #64748b, #334155); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form9" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #3b82f6, #1d4ed8);">
                <i class="fa-solid fa-mars me-2"></i> Erectile Dysfunction &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-ed" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                  <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_14" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_15" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="issue_existed">How long has the issue existed?</label><input type="text" class="form-control" name="issue_existed" id="issue_existed" required></div>
                        <div class="col-md-6"><label class="form-label" for="any_erection">Can you achieve any erection?</label><input type="text" class="form-control" name="any_erection" id="any_erection" required></div>
                        <div class="col-md-6"><label class="form-label" for="gradual_onset">Sudden or gradual onset?</label><input type="text" class="form-control" name="gradual_onset" id="gradual_onset" required></div>
                        <div class="col-md-6"><label class="form-label" for="heart_disease">History of heart disease?</label><input type="text" class="form-control" name="heart_disease" id="heart_disease" required></div>
                         <div class="col-md-6"><label class="form-label" for="Diabetes">Diabetes?</label><input type="text" class="form-control" name="Diabetes" id="Diabetes" required></div>
                        <div class="col-md-6"><label class="form-label" for="alcohol_intake">Smoking or alcohol intake?</label><input type="text" class="form-control" name="alcohol_intake" id="alcohol_intake" required></div>
                        <div class="col-md-6"><label class="form-label" for="ED_medication">Currently using ED medication?</label><input type="text" class="form-control" name="ED_medication" id="ED_medication" required></div>

                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_106" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_106" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_106" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_106_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-ed')" class="btn btn-primary px-4" style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    </div>
    <div id="form10" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #8b5cf6, #6d28d9);">
                <i class="fa-solid fa-clock-rotate-left me-2"></i> Premature Ejaculation &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-pe" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                  <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_16" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_17" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="ejaculation">Typical ejaculation time?</label><input type="text" class="form-control" name="ejaculation" id="ejaculation" required></div>

                            <div class="col-md-6"><label class="form-label" for="Lifelong">Lifelong or recent issue?</label><input type="text" class="form-control" name="Lifelong" id="Lifelong" required></div>

                            <div class="col-md-6"><label class="form-label" for="anxiety">Stress or anxiety present?</label><input type="text" class="form-control" name="anxiety" id="anxiety" required></div>

                   <div class="col-md-6"><label class="form-label" for="Any_erectile">Any erectile problems?</label><input type="text" class="form-control" name="Any_erectile" id="Any_erectile" required></div>

                    <div class="col-md-6"><label class="form-label" for="treatment_before">Tried treatment before?</label><input type="text" class="form-control" name="treatment_before" id="treatment_before" required></div>

                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_105" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_105" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_105" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_105_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-pe')" class="btn btn-primary px-4" style="background: linear-gradient(135deg, #8b5cf6, #6d28d9); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <div id="form11" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #10b981, #047857);">
                <i class="fa-solid fa-scissors me-2"></i>Acne Skin Condition  &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-hairloss" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                 <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_18" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_19" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="loss_started">Age when hair loss started?</label><input type="text" class="form-control" name="loss_started" id="loss_started" required></div>

                        <div class="col-md-6"><label class="form-label" for="Family_history">Family history?</label><input type="text" class="form-control" name="Family_history" id="Family_history" required></div>

                        <div class="col-md-6"><label class="form-label" for="hair_loss">Pattern of hair loss?</label><input type="text" class="form-control" name="hair_loss" id="hair_loss" required></div>

                         <div class="col-md-6"><label class="form-label" for="loss_products">Using hair loss products?</label><input type="text" class="form-control" name="loss_products" id="loss_products" required></div>
                         <div class="col-md-6"><label class="form-label" for="scalp_disease">Any scalp disease?</label><input type="text" class="form-control" name="scalp_disease" id="scalp_disease" required></div>

                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Other medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
<br>
<br>
<br>
                        ...
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_104" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_104" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_104" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_104_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-hairloss')" class="btn btn-success px-4" style="background: linear-gradient(135deg, #10b981, #047857); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form12" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #a855f7, #7e22ce);">
                <i class="fa-solid fa-bacteria me-2"></i>Acne Skin Condition &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-cystitis" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Acne Skin Condition">
                   <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label">Date of Birth</label><input type="date" class="form-control" name="dob" required></div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_20" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_21" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="whiteheads">Type of acne (whiteheads, cystic)?</label><input type="text" class="form-control" name="whiteheads" id="whiteheads" required></div>
                         <div class="col-md-6"><label class="form-label" for="Areas_affected">Areas affected?</label><input type="text" class="form-control" name="Areas_affected" id="Areas_affected" required></div>
                          <div class="col-md-6"><label class="form-label" for="Duration">Duration?</label><input type="text" class="form-control" name="Duration" id="Duration" required></div>
                          <div class="col-md-6"><label class="form-label" for="Severity">Severity?</label><input type="text" class="form-control" name="Severity" id="Severity" required></div>
                          <div class="col-md-6"><label class="form-label" for="any_treatments">Using any treatments?</label><input type="text" class="form-control" name="any_treatments" id="any_treatments" required></div>
                          <div class="col-md-6"><label class="form-label" for="Hormonal_issues">Hormonal issues?</label><input type="text" class="form-control" name="Hormonal_issues" id="Hormonal_issues" required></div>

                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_103" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_103" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_103" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_103_text" rows="2"></textarea>
                        </div>
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary">
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-cystitis')" class="btn btn-primary px-4" style="background: linear-gradient(135deg, #a855f7, #7e22ce); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form13" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #0d9488, #0f766e);">
                <i class="fa-solid fa-weight-scale me-2"></i> Rosacea Skin Condition &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-weightloss" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy">
                  <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label">Date of Birth</label><input type="date" class="form-control" name="dob" required></div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_22" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_23" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                         <div class="col-md-6"><label class="form-label" for="Facial_redness">Facial redness or flushing?</label><input type="text" class="form-control" name="Facial_redness" id="Facial_redness" required></div>
                         <div class="col-md-6"><label class="form-label" for="Triggers ">Triggers (heat, alcohol, stress)?</label><input type="text" class="form-control" name="Triggers" id="Triggers" required></div>
                         <div class="col-md-6"><label class="form-label" for="Pimples_present">Pimples present?</label><input type="text" class="form-control" name="Pimples_present" id="Pimples_present" required></div>
                         <div class="col-md-6"><label class="form-label" for="Eye_symptoms">Eye symptoms?</label><input type="text" class="form-control" name="Eye_symptoms" id="Eye_symptoms" required></div>
                         <div class="col-md-6"><label class="form-label" for="steroid_creams">Using steroid creams?</label><input type="text" class="form-control" name="steroid_creams" id="steroid_creams" required></div>
                         

                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_102" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_102" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_102" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_102_text" rows="2"></textarea>
                        </div>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-weightloss')" class="btn btn-success px-4" style="background: linear-gradient(135deg, #0d9488, #0f766e); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form14" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #f43f5e, #be123c);">
                <i class="fa-solid fa-person-running me-2"></i>Eczema Skin Condition &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-periodpain" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy">
                <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_24" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_25" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                        <div class="col-md-6"><label class="form-label" for="Areas_affected">Areas affected?</label><input type="text" class="form-control" name="Areas_affected" id="Areas_affected" required></div>
                        <div class="col-md-6"><label class="form-label" for="Itching_severity">Itching severity?</label><input type="text" class="form-control" name="Itching_severity" id="Itching_severity" required></div>
                        <div class="col-md-6"><label class="form-label" for="Childhood_eczema">Childhood eczema history?</label><input type="text" class="form-control" name="Childhood_eczema" id="Childhood_eczema" required></div>
                         <div class="col-md-6"><label class="form-label" for="Triggers">Triggers?</label><input type="text" class="form-control" name="Triggers" id="Triggers" required></div>
                         <div class="col-md-6"><label class="form-label" for="infections_present">Skin infections present?</label><input type="text" class="form-control" name="infections_present" id="infections_present" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_101" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_101" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_101" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_101_text" rows="2"></textarea>
                        </div>
...
<div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-periodpain')" class="btn btn-danger px-4" style="background: linear-gradient(135deg, #f43f5e, #be123c); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form15" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #64748b, #334155);">
                <i class="fa-solid fa-ban me-2"></i>Psoriasis Skin Condition &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-stopsmoking" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy">
                 <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_allergies">Do you have any allergies? </label>
                            <select class="form-select toggle-details" name="any_allergies" id="any_allergies" data-target="details_any_allergies_26" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="any_medication">Are you currently taking any medication? </label>
                            <select class="form-select toggle-details" name="any_medication" id="any_medication" data-target="details_any_medication_27" required>
                                <option selected disabled value="">Select Option</option>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        ...
                        <div class="col-md-6"><label class="form-label" for="medical_conditions">Do you have any long-term medical conditions?</label><input type="text" class="form-control" name="medical_conditions" id="medical_conditions" required></div>
                          <div class="col-md-6"><label class="form-label" for="Location_of">Location of patches?</label><input type="text" class="form-control" name="Location_of" id="Location_of" required></div>
                           <div class="col-md-6"><label class="form-label" for="Nail_nvolvement">Nail involvement?</label><input type="text" class="form-control" name="Nail_nvolvement" id="Nail_nvolvement" required></div>
                            <div class="col-md-6"><label class="form-label" for="Joint_pain">Joint pain?</label><input type="text" class="form-control" name="Joint_pain" id="Joint_pain" required></div>
                               <div class="col-md-6"><label class="form-label" for="Family">Family history?</label><input type="text" class="form-control" name="Family" id="Family" required></div>
                                <div class="col-md-6"><label class="form-label" for="Previous_treatments">Previous treatments?</label><input type="text" class="form-control" name="Previous_treatments" id="Previous_treatments" required></div>


                        <div class="col-md-6">
                            <label class="form-label d-block">Have you used online doctor services before?</label>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_100" type="radio" name="services_before" id="services_yes" value="Yes" required>
                                <label class="form-check-label" for="services_yes">I confirm the information provided is accurate</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input toggle-details" data-target="details_services_100" type="radio" name="services_before" id="services_no" value="No" required>
                                <label class="form-check-label" for="services_no">No, this is my first time</label>
                            </div>
                        </div>
                        <div id="details_services_100" class="col-md-12 conditional-details">
                            <label class="form-label">Please provide details about previous services used</label>
                            <textarea class="form-control" name="details_services_100_text" rows="2"></textarea>
                        </div>
...
<div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-stopsmoking')" class="btn btn-secondary px-4" style="background: linear-gradient(135deg, #64748b, #334155); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form16" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #f97316, #c2410c);">
                <i class="fa-solid fa-hand-dots me-2"></i> Acne &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-acne" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Acne">
                   <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label">Area affected?</label><input type="text" class="form-control" name="area" placeholder="e.g. Face, Back" required></div>
                        <div class="col-md-6"><label class="form-label">Type of acne?</label>
                            <select class="form-select" name="type" required>
                                <option>Blackheads/Whiteheads</option><option>Pustules/Papules</option><option>Cystic</option><option>Not sure</option>
                            </select>
                        </div>
                        <div class="col-md-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" required>
                                <label class="form-check-label text-muted small">I confirm the information provided is accurate. This service is not for emergencies.</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-acne')" class="btn btn-warning px-4" style="background: linear-gradient(135deg, #f97316, #c2410c); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form17" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #facc15, #ca8a04);">
                <i class="fa-solid fa-face-angry me-2"></i> Rosacea &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-rosacea" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                   <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label">Main symptoms?</label><input type="text" class="form-control" name="symptoms" placeholder="e.g. Redness, Bumps" required></div>
                        <div class="col-md-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" required>
                                <label class="form-check-label text-muted small">I confirm the information provided is accurate. This service is not for emergencies.</label>
                    ...
                    <div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-rosacea')" class="btn btn-warning px-4" style="background: linear-gradient(135deg, #facc15, #ca8a04); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form18" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #fbbf24, #d97706);">
                <i class="fa-solid fa-hand-fist me-2"></i> Eczema &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-eczema" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                   <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
...
<div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-eczema')" class="btn btn-warning px-4" style="background: linear-gradient(135deg, #fbbf24, #d97706); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form19" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #f59e0b, #9a3412);">
                <i class="fa-solid fa-virus-slash me-2"></i> Psoriasis &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-psoriasis" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                   <div class="row g-3">
                        <div class="col-md-6"><label class="form-label">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label">Area affected?</label><input type="text" class="form-control" name="area" required></div>
                        <div class="col-md-12">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" required>
                                <label class="form-check-label text-muted small">I confirm the information provided is accurate. This service is not for emergencies.</label>
...
<div class="d-flex justify-content-between mt-4">
                        <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                        <button type="button" onclick="submitRegistration('form-psoriasis')" class="btn btn-warning px-4" style="background: linear-gradient(135deg, #f59e0b, #9a3412); border: none;">Book Appointment</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="form20" class="step3-form-wrap mt-4">
        <div class="card shadow-sm border-0">
            <div class="card-header text-white fw-bold fs-5 py-3" style="background: linear-gradient(135deg, #1d4ed8, #4338ca);">
                <i class="fa-solid fa-comments me-2"></i> Counselling Therapy &mdash; Appointment Form
            </div>
            <div class="card-body p-4">
                <form id="form-counseling" action="{{ route('appointment.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="appointmentType" value="Order Counselling Therapy Coming Soon">
                    <div class="row g-3">
                        <div class="col-md-6"><label class="form-label" for="full_name">Full Name</label><input type="text" class="form-control" name="full_name" required></div>
                        <div class="col-md-6"><label class="form-label" for="date_of_birth">Date of Birth</label><input type="date" class="form-control" name="date_of_birth" required></div>
                        <div class="col-md-6">
                            <label class="form-label" for="gender">Gender</label>
                            <select class="form-select" name="gender" required>
                                <option selected disabled value="">Choose Gender</option>
                        ...
                        <div class="col-md-12">
                            <label class="form-label" for="counseling_reason">Primary Reason for Seeking Counseling</label>
                            <textarea class="form-control" name="counseling_reason" rows="3" placeholder="e.g., Anxiety, Depression, Relationship issues..." required></textarea>
                        </div>
                        
                        <div class="col-md-6">
                            <label class="form-label" for="previous_therapy">Have you had therapy before?</label>
                            <select class="form-select" name="previous_therapy" required>
                                <option value="No">No</option>
                                <option value="Yes">Yes</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label" for="emergency_contact">Emergency Contact Name & Phone</label>
                            <input type="text" class="form-control" name="emergency_contact" placeholder="Name - Phone Number" required>
                        </div>

                        <!-- Date Selection Requested by User -->
                        <div class="col-md-12 mt-3">
                            <div class="p-3 rounded-3" style="background-color: #f0f9ff; border: 1px solid #bae6fd;">
                                <label class="form-label fw-bold text-primary" for="appointmentDate">
                                    <i class="fa-solid fa-calendar-check me-2"></i> Select Appointment Date
                                </label>
                                <input type="date" class="form-control border-primary" name="appointmentDate" id="appointmentDate" required min="{{ date('Y-m-d') }}">
                                <small class="text-muted">Please select your preferred date for the session.</small>
                            </div>
                        </div>
                    ...
                    <!-- Prescription Delivery (Optional for Counseling but kept for structure consistent with other forms) -->
                    <div class="mt-4">
                        <label class="form-label">Note: Counselling therapy is a talk session and usually does not require prescription delivery.</label>
                    </div>

                        <!-- Prescription Delivery Feature -->
                        <div class="col-md-12 mb-3 prescription-delivery-wrapper">
                            <label class="form-label">Select Prescription Delivery (in case medication is required)</label>
                            <select class="form-select prescription-delivery-select" name="prescriptionDelivery">
                                <option selected disabled>Choose Option</option>
                                <option value="Collect at Pharmacy">Collect at Pharmacy</option>
                        ...
                        <div class="col-md-12 pharmacy-options-container d-none">
                            <div class="mb-3">
                                <label class="form-label" for="pharmacyCountry">Select Country</label>
                                <select class="form-select pharmacy-country-select" name="devlivaryCountry">
                                    <option selected disabled>Choose Business State</option>
                            ...
                            <!-- Styled Pharmacy Info Box -->
                            <div class="pharmacy-info-box p-4 rounded text-white shadow-sm mb-3 d-none" style="background-color:#0dcaf0; border-radius: 10px;">
                                <p class="mb-2" style="font-size: 1.1rem; color: #fff !important;">Name: <span class="pharmacy-info-name"></span></p>
                                <p class="mb-2" style="font-size: 1.1rem; color: #fff !important;">County: <span class="pharmacy-info-county"></span></p>
                                <p class="mb-0" style="font-size: 1.1rem; color: #fff !important;">Phone: <span class="pharmacy-info-phone"></span></p>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <a href="#cards-section" class="btn btn-outline-secondary px-4"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
                            <button type="button" onclick="submitRegistration('form-counseling')" class="btn btn-primary px-4" style="background: linear-gradient(135deg, #1d4ed8, #4338ca); border: none;">Book Appointment</button>
                        </div>
                </form>
            </div>
        </div>
    ...
    <!-- Cards Section -->
    <div id="cards-section" class="step3-section">
        <h4 class="fw-bold mb-4 text-center">Select Your General Health Doctor</h4>
        <div class="row g-4">
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form1" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #6366f1, #a855f7); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-lungs" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Asthma Health</h5>
                  
                    <span class="badge bg-light text-primary px-3 py-2">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form2" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #f43f5e, #be123c); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-house-medical" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Migraine</h5>

                    <span class="badge bg-light text-danger px-3 py-2">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form3" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #10b981, #059669); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-heart-pulse" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Order Counselling Therapy Coming Soon</h5>

                    <span class="badge bg-light text-success px-3 py-2">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form4" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #0ea5e9, #2563eb); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-brain" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold"> Hay Fever / Allergies</h5>

                    <span class="badge bg-light text-info px-3 py-2">Book Now</span>
                </a>
            </div>
            <div class="col-12"><h4 class="fw-bold text-center mt-3">Select Your Women's Health Doctor</h4></div>
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form5" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #f59e0b, #ea580c); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-venus" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Contraception Health</h5>
                   
                    <span class="badge bg-light text-warning px-3 py-2">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form6" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #d946ef, #a21caf); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-hand-dots" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Period Delay Treatment</h5>
                    
                    <span class="badge bg-light text-primary px-3 py-2" style="color: #a21caf !important;">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form7" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #14b8a6, #0f766e); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-head-side-virus" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Genital Thrush </h5>
    
                    <span class="badge bg-light text-teal px-3 py-2" style="color: #0f766e !important;">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form8" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #ec4899, #be185d); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-virus" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Bacterial Vaginosis</h5>
                    <span class="badge bg-light text-danger px-3 py-2" style="color: #be185d !important;">Book Now</span>
                </a>
            </div>
            <!-- Cystitis & Period Pain -->
           
            

            <div class="col-12"><h4 class="fw-bold text-center mt-3">Select Your Men's Health Doctor</h4></div>
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="#form9" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-mars" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Erectile Dysfunction</h5>
                    <span class="badge bg-light text-primary px-3 py-2">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="#form10" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #8b5cf6, #6d28d9); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-clock-rotate-left" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Premature Ejaculation</h5>
                    <span class="badge bg-light text-primary px-3 py-2" style="color: #6d28d9 !important;">Book Now</span>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-lg-4">
                <a href="#form11" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #10b981, #047857); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-scissors" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Acne Skin Condition</h5>
                    <span class="badge bg-light text-success px-3 py-2">Book Now</span>
                </a>
            </div>
             <div class="col-12"><h4 class="fw-bold text-center mt-3">Select Your Skin Condition  Doctor</h4></div>
   <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form12" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg,#953de4,#953de4); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-scissors" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Acne Skin Condition</h5>
                    <span class="badge bg-light text-success px-3 py-2">Book Now</span>
                </a>
          ...
          <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form13" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #0e857b,#0e857b); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-scissors" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Rosacea Skin Condition</h5>
                    <span class="badge bg-light text-success px-3 py-2">Book Now</span>
                </a>
            </div>

             <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form14" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg,#da294d,#da294d); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-scissors" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Eczema Skin Condition </h5>
                    <span class="badge bg-light text-success px-3 py-2">Book Now</span>
                </a>
            </div>

             <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form15" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg,#49586d, #49586d); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-scissors" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Psoriasis Skin Condition</h5>
                    <span class="badge bg-light text-success px-3 py-2">Book Now</span>
                </a>
            </div>
            
            <!-- <div class="col-12 col-sm-6 col-lg-3">
                <a href="#form20" class="service-card p-4 d-block rounded-3 shadow-sm text-center text-white" 
                   style="background: linear-gradient(135deg, #1d4ed8, #4338ca); min-height: 250px;">
                    <div class="mb-3"><i class="fa-solid fa-comments" style="font-size: 3rem;"></i></div>
                    <h5 class="fw-bold">Order Counselling Therapy</h5>
                    <span class="badge bg-light text-primary px-3 py-2">Book Now</span>
                </a>
            </div> -->
        </div>
    ...
    <!-- Bottom Nav -->
    <div id="cards-nav" class="d-flex justify-content-end gap-2 mt-4">
        <button class="btn btn-secondary px-4" onclick="prevStep(2)">Previous</button>
    </div>
...
<script>
    ...
    "Wicklow": [
        ...
        // 1. Existing Yes/No Toggle Logic
        ...
        // 2. Prescription Delivery Logic
        function handleDeliveryToggle(select) {
            const form = select.closest('form');
            if (!form) return;
            const container = form.querySelector('.pharmacy-options-container');
            if (!container) return;
            
            if (select.value === 'Collect at Pharmacy') {
                container.classList.remove('d-none');
                container.querySelectorAll('select').forEach(s => s.setAttribute('required', 'required'));
            } else {
                container.classList.add('d-none');
                container.querySelectorAll('select').forEach(s => s.removeAttribute('required'));
            }
        }
        ...
        function handleCountryChange(select) {
            const form = select.closest('form');
            if (!form) return;
            const pharmacySelect = form.querySelector('.pharmacy-name-select');
            if (!pharmacySelect) return;
            const country = select.value;
            
            pharmacySelect.innerHTML = '<option selected disabled>Choose Pharmacy</option>';
            
            if (pharmacyData[country]) {
                pharmacyData[country].forEach(pharmacy => {
            ...
            const infoBox = form.querySelector('.pharmacy-info-box');
            if (infoBox) infoBox.classList.add('d-none');
        }

        function handlePharmacyChange(select) {
            const form = select.closest('form');
            if (!form) return;
            const countrySelect = form.querySelector('.pharmacy-country-select');
            const infoBox = form.querySelector('.pharmacy-info-box');
            if (!countrySelect || !infoBox) return;
            
            const country = countrySelect.value;
            const pharmacyName = select.value;
            const pharmacy = pharmacyData[country]?.find(p => p.name === pharmacyName);
            
            if (pharmacy) {
                form.querySelector('.pharmacy-info-name').textContent = pharmacy.name;
                form.querySelector('.pharmacy-info-county').textContent = pharmacy.county;
                form.querySelector('.pharmacy-info-phone').textContent = pharmacy.phone;
                const hiddenPhone = form.querySelector('.pharmacy-phone-hidden');
                if (hiddenPhone) hiddenPhone.value = pharmacy.phone;
        ...
        // 5. Centralized AJAX Submission Logic
                ...
                const originalBtnContent = submitBtn.innerHTML;
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                Swal.fire({
                                    title: 'Error!',
                                    text: data.message || 'Validation failed. Please check the fields.',
                                    icon: 'error',
                                    confirmButtonText: 'OK',
        ...
        document.addEventListener('change', function(e) {
            ...
            if (e.target.classList.contains('prescription-delivery-select')) {
                handleDeliveryToggle(e.target);
            }
            if (e.target.classList.contains('pharmacy-country-select')) {
                handleCountryChange(e.target);
            }
            if (e.target.classList.contains('pharmacy-name-select')) {
                handlePharmacyChange(e.target);
            }
        });

        // Initialize existing Yes/No toggles
        document.querySelectorAll('.toggle-details').forEach(field => {
            handleToggle(field);
        });
    });
</script>
